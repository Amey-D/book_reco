...
row1_1.markdown("**To begin, please enter the link to your [Goodreads profile](https://www.goodreads.com/) (or just use mine!).** 👇")
...
need_help = row2_1.beta_expander('Need help? 👉')
	# with need_help:
